                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: const DecorationImage(
                                  fit: BoxFit.cover, image: detailsPageLikeBg),
                            ),
                            child: InkWell(
                              onTap: () {
                                detailsPageController.likeProfile(
                                    detailsPageController.like.value);
                              },
                              child: Stack(
                                children: [
                                  const Align(
                                  ...
                                  Align(
                                    ...
                                    child: Icon(
                                      Icons.favorite,
                                      color: detailsPageController.like.value ==
                                              true
                                          ? Colors.deepPurple
                                          : Colors.white,
                                      size: 45,
